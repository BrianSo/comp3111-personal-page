    ...
    render: function() {
        return (
            <div>
                        ...
                        <div className="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <div className="menu">
                                <ul className="nav navbar">
                                    ...
                                    <li><a href="#" data-toggle="modal" data-target="#this-site" className="w3ls-hover"><span data-letters="This Site">This Site</span></a></li>
                ...
                <div className="top-nav use-space"></div>
            </div>
        );
    }
});
